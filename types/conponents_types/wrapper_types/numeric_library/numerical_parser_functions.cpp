...
{
	    /*
  * To read one input on a single line 
  * like java For Integer.parseIn(in.readLine()) we can use
  * stoi  stringStream  sscanf    atoi    
  *
  * Like java for String.ValueOf()
  * ostringStream     sprintf   to string
  *
  * in C    integer : atoi          String : sprintf
  * in C++  integer : istringStream     String : ostringStream
  * in C++11 integer : stoi         String : toString
  */
