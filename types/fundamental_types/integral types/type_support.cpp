...
int main()
{
	//basic built-in type
		//intergral type
		{
			signed char c = 'a';		//1 byte =  -128 to 127 fixed to int8_t
			unsigned char uc ; 			//1 byte =  0 to 255 fixed to uint8_t
        	...
        	//std::byte 					//from C+11 type to represent a collection of bit
